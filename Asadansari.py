...
\033[1;94m ┈┈┈▕▕▂╱╲▂▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕▂╱╲▂▏▏┈┈┈
\033[1;94m ┈┈┈┈╲┊┊┊┊╱┈┈┈┈\033[1;94mAsadaliansari.\033[1;91m┈┈┈┈╲┊┊┊┊╱┈┈┈┈
\033[1;96m ┈┈┈┈▕╲▂▂╱▏┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈▕╲▂▂╱▏┈┈┈┈
\033[1;96m ╱▔▔▔▔┊┊┊┊▔▔▔▔╲☞☞☞☞☞☞\033[1;91m☜☜☜☜☜╱▔▔▔▔┊┊┊┊▔▔▔▔╲
\033[1;96m................\033[1;93mAsadaliansari\033[1;91m...............
\033[1;96m................\033[1;93m✬🄵🄰🄲🄴🄱🄾🄾🄺✬\033[1;91m..............

\033[1;96m░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░

\033[1;91m☞ Auther     : ASAD_ALI_ANSARI_MASTER
\033[1;92m☞ WhatsApp   : 03144795189
...
def login():
	...
	try:
		...
		pwd=getpass.getpass(S + '[♡] ' + R + 'Ansari: ')
...
def menu():
	...
	cb()
	print (logo)
	print (S + '[☆] ' + G + 'ID Name: ' + R + a['Asad'])
	print (S + '[☆] ' + G + 'User ID: ' + R + a['Ansari'])
	print
	print (S + 50*'-')
	print
	print (S + '[' + P + '☞1' + S + ']' + S + ' Fast Cloning New Update')
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update B4_BALOCH Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' ASAD ANSARI WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/ASAD ANSARI)
	    os.system('cd $HOME && git clone https://github.com/Asad404/Ansari')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('WhatsApp Num 03144795189✓')
	    psb('WellCome To Asad_Ansari)
	    psb('Congratulations ASAD_ANSARI Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ 786786✓')
	    psb('🔓Password ☆ 786786✓')
	    psb('Subscrib My Youtube Channel ASAD ANSARI M3N74L BRAND✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/ASAD_ANSARI && python2 B4.py')
	elif bm =='3':
